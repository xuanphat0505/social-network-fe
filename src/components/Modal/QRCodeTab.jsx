...
const QRCodeTab = ({ user, onScanSuccess }) => {
  ...
  return (
    <div className="qr-code-tab-content">
      ...
      <div className="qr-container flex flex-col items-center justify-center p-4 min-h-[300px] sm:min-h-[350px]">
        {activeMode === 'display' ? (
          ...
          <div className="w-full animate-fade-in relative flex flex-col items-center">
            <div
              className={`scanner-viewport relative w-full max-w-[300px] aspect-square rounded-2xl overflow-hidden border-2 border-[#7269ef] ${isFrontCamera ? 'is-front' : ''}`}
            >
